...
import {
  ...
  CreditCard, CalendarDays, Settings, Flame, Dumbbell, UserPlus, UsersRound, Smartphone,
} from "lucide-react";
...
const ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  LayoutDashboard, TrendingUp, Users, ClipboardCheck, Award, Wallet, AlarmClock, CreditCard, CalendarDays, Settings, Dumbbell, UserPlus, UsersRound, Smartphone,
};
